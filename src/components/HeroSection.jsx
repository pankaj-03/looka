  ...
  return (
    <section className="py-16">
      <div className="flex flex-col justify-center items-center space-y-8">
        <h1 className="text-5xl font-semibold text-center">Design your own beautiful brand</h1>
        ...
        <div className="flex md:flex-row flex-col md:space-x-2 md:space-y-0 space-y-4">
          ...
          <div className="bg-indigo-600 text-white text-nowrap rounded-lg md:px-5 md:py-5 py-5 sm:px-24 px-18 text-center">
            Get Started
          </div>
        </div>
        <div>
