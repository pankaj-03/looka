    ...
    return (
        <section>
            <div className="flex flex-col items-center justify-center">
                ...
                <div className="grid md:grid-cols-2 grid-cols-1 lg:p-4 p-2">
                    ...
                    <div className="col-span-1 flex flex-col items-start  justify-center lg:px-16 md:px-12 md:py-16 px-2 py-4">
                        <h3 className="lg:text-4xl md:text-3xl text-4xl font-semibold"><span className="text-indigo-600">01.</span> Make a logo in minutes</h3>
                        ...
                        <button className="bg-indigo-600 px-5 py-3 md:py-2 md:px-3 lg:px-5 lg:py-3 text-white rounded-md lg:ml-6 md:ml-3 ml-6">Get Started</button>
                    </div>
            ...
            <h2 className="md:text-5xl text-3xl font-semibold max-w-11/12 lg:max-w-1/2 text-center">The easiest way to design and launch your new business</h2>
                ...
                <div className="grid md:grid-cols-2 grid-cols-1 lg:p-4  p-2">
                    <div className="order-2 md:order-none col-span-1 flex flex-col  items-start justify-center  lg:ml-32  lg:px-16 md:px-12 md:py-16 px-2 py-4">
                        <h3 className="lg:text-4xl md:text-3xl text-4xl font-semibold"><span className="text-indigo-600">02.</span>Bring your brand to life </h3>
                        <p className="text-lg md:text-base max-w-md md:max-w-xl lg:max-w-md p-6 md:p-2 lg:p-6 text-gray-500">With your logo design finalized, it’s time to start building your brand identity. Looka’s Brand Kit uses your logo, colors, and fonts to instantly create hundreds of branded marketing materials—all in one spot.</p>
                        <button className="bg-indigo-600 px-5 py-3 md:py-2 md:px-3 lg:px-5 lg:py-3 text-white rounded-md lg:ml-6 md:ml-3 ml-6">Get Started</button>
                    </div>
                ...
                <div className="grid md:grid-cols-2 grid-cols-1 lg:p-4 p-2">
                    ...
                    <div className="col-span-1 flex flex-col items-start  justify-center lg:px-16 md:px-12 md:py-16 px-2 py-4">
                        <h3 className="lg:text-4xl md:text-3xl text-4xl font-semibold"><span className="text-indigo-600">03.</span>Market your business</h3>
