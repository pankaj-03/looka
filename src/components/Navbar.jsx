    ...
    <header className="h-20  w-full  shadow-sm sticky top-0 z-[100]  lg:mb-8  bg-white px-2">
      <div className="container max-w-full mx-auto  grid lg:grid-cols-4 grid-cols-2 md:items-center p-4">
        <div className="col-span-1   flex justify-start ">
          <img src={logo} alt="LOGO" className="w-[90px] h-8"></img>
        </div>
        ...
        <nav className={`${showMenu ? "hidden" : "flex"} col-span-3   lg:static absolute top-20 lg:top-0  left-0 w-full lg:col-span-3 flex lg:flex-row flex-col lg:items-center px-2 lg:px-0   lg:mt-0 lg:bg-none bg-white justify-between`}>
          ...
          <div className="flex lg:flex-row flex-col-reverse   justify-between gap-6 items-center">
            <div>
              <p className="text-lg md:text-sm lg:text-base font-medium text-nowrap text-slate-950 ">Log in</p>
            </div>

            <div className="w-full flex justify-center">
              <button className="bg-indigo-600 rounded-sm md:px-5 px-16 py-2 lg:py-3">
